...
def _make_price_chart(symbol: str, hist: pd.DataFrame, m: dict) -> "go.Figure":
    ...
    try:
        ...
        fig.add_hline(y=last_p, line_dash="dot",
                      line_color=line_col, line_width=1, opacity=0.5)
        ...
        fig.update_layout(
            ...
            xaxis=dict(showgrid=False, showline=False,
                       tickfont=dict(color="#8b949e", size=9), tickformat="%b %y"),
            yaxis=dict(showgrid=True, gridcolor="#161b22", gridwidth=1,
                       showline=False, tickfont=dict(color="#8b949e", size=9), side="right"),
        )
        return fig
    except Exception:
        return None
...
def _render_cockpit(symbol: str, m: dict, j: dict, hist: pd.DataFrame):
    ...
    # ── Datenquellen-Hinweis (nach Stufe 1→2→3→4) ────────────────────────────
    st.markdown(
        '<div style="background:#161b22;border:1px solid #30363d;border-radius:6px;'
        'padding:8px 12px;margin-bottom:8px;">'
        '<span style="color:#8b949e;font-size:0.72em;font-weight:700;'
        'letter-spacing:1px;">JACK DATEN-HIERARCHIE</span>'
        '<table style="width:100%;border-collapse:collapse;font-size:0.72em;margin-top:5px;">'
        '<tr style="border-bottom:1px solid #21262d;">'
        '<th style="color:#8b949e;padding:3px 8px;text-align:left;font-weight:600;">Stufe</th>'
        '<th style="color:#8b949e;padding:3px 8px;text-align:left;font-weight:600;">Quelle</th>'
        '<th style="color:#8b949e;padding:3px 8px;text-align:left;font-weight:600;">Verwendung</th>'
        '<th style="color:#8b949e;padding:3px 8px;text-align:left;font-weight:600;">Tag</th>'
        '</tr>'
        '<tr>'
        '<td style="padding:4px 8px;color:#3fb950;font-weight:700;white-space:nowrap;">Stufe 1 ⭐</td>'
        '<td style="padding:4px 8px;color:#c9d1d9;">SEC EDGAR · 10-K · Investor Relations</td>'
        '<td style="padding:4px 8px;color:#8b949e;">Primärquelle · K-Kriterien</td>'
        '<td style="padding:4px 8px;"><span style="background:#3fb95022;border:1px solid #3fb950;'
        'color:#3fb950;border-radius:3px;padding:1px 5px;font-weight:700;">[GOLD STANDARD]</span></td>'
        '</tr><tr>'
        '<td style="padding:4px 8px;color:#79c0ff;font-weight:700;white-space:nowrap;">Stufe 2</td>'
        '<td style="padding:4px 8px;color:#c9d1d9;">Koyfin · TIKR · StockAnalysis · Macrotrends</td>'
        '<td style="padding:4px 8px;color:#8b949e;">Sekundärquelle · Bestätigung</td>'
        '<td style="padding:4px 8px;"><span style="background:#79c0ff22;border:1px solid #79c0ff;'
        'color:#79c0ff;border-radius:3px;padding:1px 5px;font-weight:700;">[VERIFIED]</span></td>'
        '</tr><tr>'
        '<td style="padding:4px 8px;color:#e3b341;font-weight:700;white-space:nowrap;">Stufe 3</td>'
        '<td style="padding:4px 8px;color:#c9d1d9;">Yahoo Finance (yfinance)</td>'
        '<td style="padding:4px 8px;color:#8b949e;">Screening-Feed · Single-Source</td>'
        '<td style="padding:4px 8px;"><span style="background:#e3b34122;border:1px solid #e3b341;'
        'color:#e3b341;border-radius:3px;padding:1px 5px;font-weight:700;">[TRAINING]</span></td>'
        '</tr><tr>'
        '<td style="padding:4px 8px;color:#d29922;font-weight:700;white-space:nowrap;">Stufe 4</td>'
        '<td style="padding:4px 8px;color:#c9d1d9;">Schätzungen / WACC-Komponenten</td>'
        '<td style="padding:4px 8px;color:#8b949e;">Nur E-Kriterien &amp; WACC</td>'
        '<td style="padding:4px 8px;"><span style="background:#d2992222;border:1px solid #d29922;'
        'color:#d29922;border-radius:3px;padding:1px 5px;font-weight:700;">[ESTIMATE]</span></td>'
        '</tr></table>'
        '</div>',
        unsafe_allow_html=True)
